    ...
    async function fetchData() {
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                setDatePart(
                    new Date(data.result[0].created_at)
                        .toISOString()
                        .split('T')[0],
                )
                // view 상태를 업데이트하기
            ...
            {loading ? (
                ...
                <div className="">
                    ...
                    <div className="flex flex-col items-center mt-10">
                        ...
                        <div
                            className={
                                'h-[23rem] flex flex-row justify-center mt-5 '
                            }
                        >
                            {imgView.length > 3 && (
                                ...
                                <div className="flex flex-row mt-5 opacity-60 hover:opacity-100 rounded-full">
                                    ...
                                    >
                                        {currentTheme === 'dark' ? (
                                            <Image
                                                src="/arrow-right.png"
                                                className="w-7 opacity-50 ml closeWhite"
                                            />
                                        ) : (
                                            <Image
                                                src="/arrow-right.png"
              ...
              ===========================*/}
                    ...
                    <div className="flex justify-center items-center flex-col mt-16 mb-10">
                        ...
                        <span className="max-w-[30rem] mt-7 opacity-70">
                            아래는 최근 한 달 동안의 감정을 기록하는 내용입니다
                            <br />한 달 동안의 다양한 경험과 감정을
                            기록해보세요. :)
                        </span>
                    </div>
                    {/* 사용자 컨테이너*/}
                    <div className="flex justify-center flex-row ">
                        <div className="flex flex-row justify-center w-4/6">
                            ...
                            <div
                                className={`w-8/12 max-w-[65rem] min-w-[60rem] flex items-center justify-center bg-white dark:bg-[#474747] opacity-90 rounded-xl shadow-xl relative  border border-neutral-200 dark:border-[#555] ${
                                    graph ? '' : ''
                                }`}
                            >
                                ...
                                >
                                    {graph ? (
                                        currentTheme === 'dark' ? (
                                            <BarChartDark view={view} />
                                        ) : (
                                            <BarChart view={view} />
                                        )
                                    ) : currentTheme === 'dark' ? (
                                        <DoughnuChartDark view={view} />
                                    ) : (
                                        <DoughnuChart view={view} />
                                    )}
                                    <div
